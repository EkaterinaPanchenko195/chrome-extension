...
const popup = (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", { className: "text-green-500 text-5xl font-bold " }, "weather"),
    react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", { src: "weather.png", alt: "icon-weather" })));
